        ...
        <div class="container">
            <div class="row justify-content-center gutter-50 col-mb-30 mt-5">
                <div class="fancy-title title-border mt-4 title-center">
                    <h4>{{ __('Front.People Looking For Work') }}</h4>
                </div>
                @foreach ($cvs as $cv)
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <img src="{{ url('storage/app/public/imgs/users/'.$cv->user_person->profile_pic) }}"
                                alt="{{ $cv->user_person->profile_pic }}" class="rounded-circle me-3" width="64" height="64" />
                            @else
                            <img src="{{ url('imgs/logo.jpg') }}" alt="{{ $cv->user_person->name }}" class="rounded-circle me-3" width="64"
                                height="64" />
                            @endif
                            <div>
                            ...
                            <div>
                                ...
                                <a href="tel:{{ $cv->user_person->phone }}"
                                ...
                                <a href="mailto:{{ $cv->user_person->email }}"
                                    class="social-icon rounded-circle mb-0 border-transparent text-white bg-facebook">
            ...
            <div class="row d-flex justify-content-end mt-2">
                <div class="col-md-2">
                    <span><a class="btn btn-primary rounded-pill button-change ms-3 px-3"
                            href="{{ route('front.home.cvs',Str::lower($country->country_code)) }}">{{ __('front.See more')}}</a></span>
                </div>
            </div>
        </div>
        @endif
