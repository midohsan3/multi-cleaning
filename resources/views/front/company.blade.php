...
--}}
@section('page-meta')
@if (isset($company->user_company->profile_pic))
<meta property="og:image" content="{{url('storage/app/public/imgs/users/'.$company->user_company->profile_pic)}}" />
@else
    ...
    <div class="oc-item">
        <div class="portfolio-item">
            ...
            <div class="portfolio-desc">
                ...
                <span class="d-flex justify-content-start"><strong>{{ __('front.Price') }}:</strong><span>{{ $servicesPrice[$photo->service_id]
                        }}</span>
                    <span>{{
