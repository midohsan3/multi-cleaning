            ...
            <div class="row">
                <div class="col-md-6 col-12 fxt-bg-color">
                    <div class="fxt-content">
                        ...
                        <div class="fxt-form">
                            <h2>{{ __('front.Personal Account') }}</h2>
                            <p>{{ __('front.If You Looking For work Register & Upload Your CV For Free.') }}</p>
                            <form method="POST" action="{{ route('front.person.store') }}">
                                @csrf
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="text" class="form-control" name="name" placeholder="{{ __('front.Your Name') }}"
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <select class="form-control" name="nationality" required="required">
                                            <option value="{{ old('nationality') }}" selected disabled>{{ __('front.Nationality') }}</option>
                                ...
                                <div class="form-group ">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="text" class="form-control" name="phone" placeholder="{{ __('front.Your Phone') }} "
