                        ...
                        <table class="nk-tb-list nk-tb-ulist is-compact">
                            <thead>
                                <tr class="nk-tb-item nk-tb-head">
                                    ...
                                    <th class="nk-tb-col">
                                        <span class="sub-text">{{ __('admin.Price') }} / {{ __('admin.Hour') }}</span>
                                    </th>
                                ...
                                <tr class="nk-tb-item">
                                    ...
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            ...
                                            <div class="user-name">
                                                <span class="tb-lead"><a href="{{ route('company.service.prices.edit',$service->id) }}">
                                                        @if (array_key_exists($service->service_id,$serviceNames))
                                    ...
                                    <td class="nk-tb-col">
                                        <a href="{{ route('company.service.prices.edit',$service->id) }}">
                                        ...
                                        <ul class="nk-tb-actions gx-2">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="#" class="btn btn-sm btn-icon btn-trigger" title="{{ __('admin.Delete') }}"
                                                    data-packageid="{{ $service->id }}" data-packagenameen="{{ $service->name_en }}"
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            ...
                                                            <li><a href="{{ route('company.service.prices.edit',$service->id) }}"
                                                                    class="text-success">
                                                                    <i class="icon fal fa-edit"></i>
                                                            ...
                                                            <li><a href="#" data-packageid="{{ $service->id }}"
                                                                    data-packagenameen="{{ $service->name_en }}"
                                                                    data-packagenamear="{{ $service->name_ar }}" data-toggle="modal"
