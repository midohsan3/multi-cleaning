          ...
          <div class="card-inner">
            <div class="card-title-group align-start mb-0">
              <div class="card-title">
                <h6 class="subtitle">{{ __('admin.Total Views') }}</h6>
              </div>
            </div>
            ...
            <div class="invest-data">
              <div class="invest-data-amount g-2">
                <div class="invest-data-history">
                  <div class="title">{{ __('admin.This Month') }}</div>
                  <div class="amount">00 </div>
                </div>
                <div class="invest-data-history">
                  <div class="title">{{ __('admin.This Week') }}</div>
                  <div class="amount">00 </div>
                </div>
              </div>
      ...
      <div class="col-md-4">
        <div class="card card-bordered card-full">
          <div class="card-inner">
            <div class="card-title-group align-start mb-0">
              <div class="card-title">
                <h6 class="subtitle">{{ __('admin.Total Booking') }}</h6>
              </div>

            </div>
            <div class="card-amount">
              <span class="amount"> {{ $ordersCount }}
              </span>
            </div>
            <div class="invest-data">
              <div class="invest-data-amount g-2">
                <div class="invest-data-history">
                  <div class="title">{{ __('admin.This Month') }}</div>
                  <div class="amount">{{ $thisMonthOrdersCount }}</div>
                </div>
                <div class="invest-data-history">
                  <div class="title">{{ __('admin.This Week') }}</div>
                  <div class="amount">{{ $thisWeekOrdersCount }} </div>
                </div>
              </div>
      ...
      <div class="col col-md-4">
        <div class="card card-bordered  card-full">
          <div class="card-inner">
            <div class="card-title-group align-start mb-0">
              <div class="card-title">
                <h6 class="subtitle">{{ __('admin.Booking Amount') }}</h6>
              </div>

            </div>
            <div class="card-amount">
              <span class="amount"> {{ number_format($ordersTotal,2) }} <span class="currency currency-usd">{{
            ...
            <div class="invest-data">
              <div class="invest-data-amount g-2">
                <div class="invest-data-history">
                  <div class="title">{{ __('admin.This Month') }}</div>
                  <div class="amount">{{ number_format($thisMonthOrdersTotal,2) }} <span class="currency currency-usd"> {{
                      $company->country_company->currency_code }}
                    </span></div>
                </div>
                <div class="invest-data-history">
                  <div class="title">{{ __('admin.This Week') }}</div>
                  <div class="amount">{{ number_format($thisWeekOrdersTotal,2) }} <span class="currency currency-usd"> {{
                      $company->country_company->currency_code }}
                    </span></div>
                </div>
              </div>
            ...
            <div class="tab-content mt-0">
              <div class="tab-pane active" id="overview">
                <div class="invest-ov gy-2">
                  <div class="subtitle">{{ __('admin.This Month') }}</div>
                  ...
                  <div class="invest-ov-details">
                    <div class="invest-ov-info">
                      <div class="amount">00,00 <span class="currency currency-usd">{{
                          $company->country_company->currency_code}}
                        </span></div>
        ...
        <div class="card card-bordered card-full">
          <div class="card-inner d-flex flex-column h-100">
            <div class="card-title-group mb-3">
              <div class="card-title">
                <h6 class="title">{{ __('admin.This Month Booking') }}</h6>
                <p></p>
              </div>
          ...
          <ul class="nk-activity">
            ...
            <li class="nk-activity-item">
              ...
              <div class="nk-activity-data">
                ...
                <span class="time"><strong>{{ __('admin.Price') }}:</strong><span>
                    ...
                    {{ $servicesPrice[$service->id] }} <span>{{ $company->country_company->currency_code }} /<span>{{
                        __('admin.Hour') }}</span></span>
                    @else
                    <span>{{ __('admin.Indeterminate') }}</span>
                    @endif
                  </span></span>
              </div>
            </li>
              ...
              <ul class="timeline-list">
                ...
                <li class="timeline-item">
                  ...
                  <div class="timeline-data">
                    <h6 class="timeline-title"><a href="{{ route('company.logo.create') }}">{{ __('admin.Company Logo') }}</a>
                    </h6>
                ...
                <li class="timeline-item">
                  <div class="timeline-date">{{ __('admin.Pending') }} <em class="icon ni ni-alarm-alt"></em></div>
                  <div class="timeline-data">
                    <h6 class="timeline-title"><a href="{{ route('company.license.create') }}">{{ __('admin.Company License')
                        }}</a></h6>
                    <div class="timeline-des">
                ...
                @if (empty($company->about_en) || empty($company->about_ar))
                <li class="timeline-item">
                  <div class="timeline-date">{{ __('admin.Pending') }} <em class="icon ni ni-alarm-alt"></em></div>
                  <div class="timeline-data">
                    <h6 class="timeline-title"><a href="{{ route('company.bio.edit') }}">{{ __('admin.Bio')
                        }}</a></h6>
                    <div class="timeline-des">
                      <p>{{ __('admin.Let Your page visitors Know more about you') }}</p>
                    </div>
                  </div>
                </li>
                @else
                <li class="timeline-item">
                  <div class="timeline-date text-success">{{ __('admin.Complete') }} <i class="icon fas fa-check"></i></div>
                  <div class="timeline-data">
                    <h6 class="timeline-title">{{ __('admin.Bio') }}</h6>
                    <div class="timeline-des">
                      <p>{{ __('admin.Let Your page visitors Know more about you') }}</p>
                    </div>
                  </div>
