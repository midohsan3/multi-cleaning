            ...
            <div class="nk-header-brand d-xl-none">
                <a href="html/index.html" class="logo-link">
                    <img class="logo-light logo-img" src="{{ url('imgs/logo.jpg') }}"
                        srcset="{{ url('imgs/logo.jpg') }} 2x" alt="Smart-Solutions">
                ...
                <div class="nk-news-list">
                    <a class="nk-news-item" href="#">
                        ...
                        <div class="nk-news-text">
                            <p>Do you know the latest update of 2025? <span> A overview of our is now available</span>
                            </p>
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status">{{ Auth::user()->role_name }}</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="lead-text">{{ Str::limit(Auth::user()->name,25) }}</span>
