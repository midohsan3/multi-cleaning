  ...
  <div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
      <div class="nk-block-head-content">
        <h3 class="nk-block-title page-title">{{ __('admin.Permissions') }}</h3>
        <div class="nk-block-des text-soft">
          <p>{{ __('admin.You have total').' '.number_format($permissionsCount,0).' '. __('admin.Feature')}}.
          </p>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-control-wrap">
                        <input type="text" class="form-control" id="nameEn" name="nameEn" placeholder="{{ __('admin.English Name Here') }}"
                          value="{{ old('nameEn') }}" autocomplete="off" required autofocus />
                        @error('nameEn')
                  ...
                  <td class="nk-tb-col">
                    <div class="user-card">
                      <div class="user-avatar xs bg-primary">
                        <span>
                          {{ Str::substr($permission->name,0,1) }}
                        </span>
                      </div>
                      <div class="user-name">
                        <span class="tb-lead">
                  ...
                  <td class="nk-tb-col nk-tb-col-tools">
                    <ul class="nk-tb-actions gx-2">
                      ...
                      <li class="nk-tb-action-hidden">
                        <a href="#" class="btn btn-sm btn-icon btn-trigger" title="{{ __('admin.Delete') }}" data-permissionid="{{ $permission->id }}"
                          data-permissionnameen="{{ $permission->name }}" data-toggle="modal" data-target="#deleteMdl">
                        ...
                        <div class="drodown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <ul class="link-list-opt no-bdr">
                              ...
                              <li><a href="#" data-permissionid="{{ $permission->id }}" data-permissionameen="{{ $permission->name}}"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('admin.role.permission.destroy') }}" method="POST">
          @csrf
          <input hidden id="permissionId" name="permissionID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
              Are You Sure You Want Delete
              <strong>
                <span id="permissionNameen"></span>
                <span>?</span>
              </strong>
            </p>
          </div>
      ...
      $(function() {
          ...
          */
          $('#deleteMdl').on('show.bs.modal', function(e) {
              ...
              let id = button.data('permissionid');
              let nameEn = button.data('permissionnameen');

              var modal = $(this);
              modal.find('.modal-body #permissionId').val(id);
              modal.find('.modal-body #permissionNameen').html(nameEn);
          });
