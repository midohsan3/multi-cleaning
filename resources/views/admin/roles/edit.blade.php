  ...
  <div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between g-3">
      <div class="nk-block-head-content">
        <h3 class="nk-block-title page-title">{{__('admin.Role')}} /
        ...
        <div class="nk-block-des text-soft">
          <ul class="list-inline">
            <li>{{__('admin.Last Update')}}: <span class="text-base">{{date('d M, Y h:i A',
                strtotime($role->updated_at))}}</span></li>
          </ul>
        </div>
      </div>
                ...
                <div class="card-inner">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="nameAr" name="name" placeholder="{{ __('admin.English Name Here') }}"
                            value="{{ old('nameAr',$role->name) }}" autocomplete="off" required autofocus />
                          @error('nameAr')
                  ...
                  <div class="row gy-4 ml-1">
                    ...
                    <div class="col-sm-4 custom-control custom-checkbox mb-1">
                      ...
                      <input type="checkbox" class="custom-control-input" id="permission{{ $permission->id }}" name="permission[]"
