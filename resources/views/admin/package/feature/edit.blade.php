  ...
  <div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between g-3">
      <div class="nk-block-head-content">
        <h3 class="nk-block-title page-title">{{__('admin.Feature')}} /
        ...
        <div class="nk-block-des text-soft">
          <ul class="list-inline">
            <li>{{__('admin.Last Update')}}: <span class="text-base">{{date('d M, Y h:i A',
                strtotime($feature->updated_at))}}</span></li>
          </ul>
        </div>
      </div>

      <div class="nk-block-head-content">
        <a href="{{route('admin.feature.index')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em
          ...
          <div class="card-inner">
            <div class="nk-block">
              ...
              <form action="{{ route('admin.feature.update') }}" method="POST">
                @csrf
                <input hidden name="feature" value="{{ $feature->id }}" />
                <div class="card-inner">
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="nameAr" name="nameAr"
                            ...
                            value="{{ old('nameAr',$feature->name_ar) }}" autocomplete="off" required autofocus />
                          @error('nameAr')
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="nameEn" name="nameEn"
                            ...
                            value="{{ old('nameEn',$feature->name_en) }}" autocomplete="off" required />
                          @error('nameEn')
                          <span class="bg-danger text-white" role="alert">{{ $message
                            }}</span>
                          @enderror
