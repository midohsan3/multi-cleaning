                                    ...
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-avatar xs bg-primary">
                                                <span>
                                                    {{ Str::substr($feature->name_en,0,1) }}
                                                </span>
                                            </div>
                                            <div class="user-name">
                                                <span class="tb-lead">
                                                    @if (App::getLocale()=='ar')
                                                    {{ Str::substr($feature->name_ar) }}
                                                    @else
                                                    {{ Str::substr($feature->name_en,2) }}
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="nk-tb-actions gx-2">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                <a href="#" class="btn btn-sm btn-icon btn-trigger"
                                                    title="{{ __('admin.Delete') }}" data-featureid="{{ $feature->id }}"
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            ...
                                                            <li><a href="{{ route('admin.feature.edit',$feature->id) }}"
                                                                    class="text-success">
                                                                    <i class="icon fal fa-edit"></i>
                                                            ...
                                                            <li><a href="#" data-featureid="{{ $feature->id }}"
                                                                    data-featurenameen="{{ $feature->name_en }}"
                                                                    data-featurenamear="{{ $feature->name_ar }}"
