  ...
  <div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
      <div class="nk-block-head-content">
        <h3 class="nk-block-title page-title">{{ __('admin.Services') }}</h3>
        <div class="nk-block-des text-soft">
          <p>{{ __('admin.You have total').' '.number_format($servicesCount,0).' '. __('admin.Service')}}.
          </p>
        </div>
                ...
                <tr class="nk-tb-item">
                  ...
                  <td class="nk-tb-col">
                    <div class="user-card">
                      <div class="user-avatar xs bg-primary">
                        <span>
                          {{ Str::substr($service->name_en,0,2) }}
                        </span>
                      </div>
                      <div class="user-name">
                        <span class="tb-lead">
                  ...
                  <td class="nk-tb-col nk-tb-col-tools">
                    <ul class="nk-tb-actions gx-2">
                      ...
                      <li class="nk-tb-action-hidden">
                        @if ($service->status==1)
                        <a href="{{ route('admin.service.deactivate',$service->id) }}"
                        ...
                        @else
                        <a href="{{ route('admin.service.activate',$service->id) }}"
                          class="btn btn-sm btn-icon btn-trigger text-success" data-toggle="tooltip"
                        ...
                        <div class="drodown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <ul class="link-list-opt no-bdr">
                              ...
                              @if ($service->status==1)
                              <li>
                                <a href="{{ route('admin.service.deactivate',$service->id) }}" class="text-danger">
                                  <i class="icon fal fa-power-off"></i>
                                  <span>{{__('admin.Deactivate')}}</span></a>
                              </li>
                              @else
                              <li>
                                <a href="{{ route('admin.service.activate',$service->id) }}" class="text-success">
                                  <i class="icon fal fa-power-off"></i>
                              ...
                              <li><a href="#" data-serviceid="{{ $service->id }}"
                                  ...
                                  data-servicenamear="{{ $service->name_ar }}" data-toggle="modal"
