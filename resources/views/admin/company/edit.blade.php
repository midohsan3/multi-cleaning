                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="nameAr" name="nameAr"
                                                        ...
                                                        value="{{ old('nameAr',$country->name_ar) }}" autocomplete="off"
                                                        required autofocus />
                                                    @error('nameAr')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="nameEn" name="nameEn"
                                                        ...
                                                        value="{{ old('nameEn',$country->name_en) }}" autocomplete="off"
                                                        required />
                                                    @error('nameEn')
                                                    <span class="bg-danger text-white" role="alert">{{ $message
                                                        }}</span>
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ariaCode"
                                                        name="ariaCode"
                                                        placeholder="{{ __('admin.Aria Code Like US') }}"
                                                        value="{{ old('ariaCode',$country->country_code) }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="naphoneCodemeEn"
                                                        name="phoneCode"
                                                        placeholder="{{ __('admin.Phone Code Here Like +1') }}"
                                                        value="{{ old('phoneCode',$country->phone_code) }}"
                                                        autocomplete="off" required />
                                                    @error('phoneCode')
                                                    <span class="bg-danger text-white" role="alert">{{ $message
                                                        }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="currency"
                                                        ...
                                                        value="{{ old('currency',$country->currency_code) }}"
                                                        autocomplete="off" required />
                                                    @error('currency')
                                                    <span class="bg-danger text-white" role="alert">{{ $message
                                                        }}</span>
